...
export abstract class Wallet {
    ...
    abstract genTx(opts: { to: { address: string, amount: number | string }[], message?: string }): Promise<{ hex: string, id: string, msg?: string, change: { address: string, amount: number }, fee: number, from: string[], to: { address: string, amount: number }[] } | undefined>;
